...
class IPOPTSolver:
    ...
    def _convert_options(self) -> Dict[str, Any]:
        ...
        opts["ipopt.alpha_red_factor"] = self.options.alpha_red_factor
        opts["ipopt.alpha_max"] = self.options.alpha_max
        opts["ipopt.alpha_min"] = self.options.alpha_min
