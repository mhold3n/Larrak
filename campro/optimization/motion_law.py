...
class MotionLawConstraints:
    ...
    def __post_init__(self):
        ...
        if self.upstroke_duration_percent + self.zero_accel_duration_percent > 100:
            raise ValueError("Upstroke and zero acceleration durations cannot exceed 100% total")
