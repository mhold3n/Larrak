...
class TertiaryOptimizer(BaseOptimizer):
    ...
    def optimize(self, objective: Callable, constraints: Any, 
        ...
        try:
            ...
            log.info(f"Using complete optimization context for tertiary optimization")
            ...
            processing_function = kwargs.get('processing_function', None)
            ...
            error_message = f"Tertiary optimization failed: {str(e)}"
