...
class CasADiMotionProblem:
    ...
    def get_problem_summary(self) -> str:
        ...
        return (f"CasADi Motion Problem: "
...
class CasADiOptimizationResult:
    ...
    def get_efficiency_metrics(self) -> Dict[str, float]:
        ...
        return {
            ...
            'efficiency_achieved': self.thermal_efficiency >= self.problem_spec.thermal_efficiency_target
        }
...
def create_default_problem(stroke: float = 0.1, cycle_time: float = 0.0385,
                          upstroke_percent: float = 50.0) -> CasADiMotionProblem:
    """
...
def create_high_efficiency_problem(stroke: float = 0.1, cycle_time: float = 0.0385) -> CasADiMotionProblem:
    """
...
def create_smooth_motion_problem(stroke: float = 0.1, cycle_time: float = 0.0385) -> CasADiMotionProblem:
    """
