...
class DummyConstraints:
    ...
    def build_collocation_problem(
        self, objective, time_horizon: float, n_points: int, initial_guess=None,
    ):
...
def test_collocation_generic_builder_and_objective_integral():
    ...
    result = optimizer.optimize(
        dummy_objective, constraints, time_horizon=1.0, n_points=200,
    )
