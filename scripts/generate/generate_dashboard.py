...
from campro.optimization.visualization import (
    plot_valve_strategy, 
    plot_motion_family, 
    plot_efficiency_map
)
...
def generate_doe_plots():
    ...
    if os.path.exists(p1_csv):
        ...
        from campro.optimization.visualization.doe import plot_efficiency_surface
...
def generate_valve_plots():
    ...
    if os.path.exists(json_path):
        ...
        from campro.optimization.visualization import plot_valve_strategy
