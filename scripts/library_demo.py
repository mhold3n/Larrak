...
from campro.constraints import CamMotionConstraints, MotionConstraints
from campro.optimization import MotionOptimizer, CollocationSettings
...
def demo_constraint_system():
    ...
    print(f"Created cam constraints:")
