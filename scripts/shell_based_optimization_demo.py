...
def run_secondary_optimization_shell(secondary_optimizer):
    ...
    print("  - Processing function: smoothness_refinement_processor")
    print("  - Objective function: smoothness_objective")
...
def run_tertiary_optimization_shell(tertiary_optimizer):
    ...
    print(f"  - Optimization targets: {optimization_targets}")
    print("  - Processing function: combined_optimization_processor")
    print("  - Objective function: combined_objective")
