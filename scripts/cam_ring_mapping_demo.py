...
from campro.optimization import (
    MotionOptimizer, SecondaryOptimizer, 
    process_linear_to_ring_follower, create_constant_ring_design
)
...
def demo_multi_objective_ring_design():
    ...
    from campro.optimization.cam_ring_processing import process_multi_objective_ring_design
