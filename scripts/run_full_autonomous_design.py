...
def main():
    ...
    # Check Output
    p1_out = "dashboard/thermo/thermo_doe_results.csv"
    ...
    p2_source_out = "dashboard/orchestration/target_motion_profile.csv"
    p2_target_out = "dashboard/final_motion_profile.csv"
    ...
    p3_out = "dashboard/gear_kinematics_results.csv"
