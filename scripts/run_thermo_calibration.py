...
def run_thermo_calibration():
    ...
    # 1. User Inputs & Scope
    # Loaded from thermo.config.CONFIG (Geometry & Ranges)
    ...
    while loop_count < max_loops and not converged:
        ...
        results_path = os.environ.get("LARRAK_THERMO_RESULTS", os.environ.get("LARRAK_PHASE1_RESULTS", "dashboard/thermo/thermo_doe_results.csv"))
