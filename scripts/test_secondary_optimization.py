...
def test_secondary_optimization_isolated():
    ...
    print(f"  - position range: [{primary_data['position'].min():.2f}, {primary_data['position'].max():.2f}] mm")
    print(f"  - velocity range: [{primary_data['velocity'].min():.2f}, {primary_data['velocity'].max():.2f}] mm/rad")
    ...
    try:
        ...
        print(f"Secondary optimization completed in {end_time - start_time:.3f} seconds")
...
def test_secondary_optimization_with_framework():
    ...
    try:
        ...
        print(f"Data after secondary update:")
        print(f"  - secondary_base_radius: {framework.data.secondary_base_radius}")
        print(f"  - secondary_cam_curves: {framework.data.secondary_cam_curves is not None}")
        ...
        print(f"  - secondary_gear_geometry: {framework.data.secondary_gear_geometry is not None}")
...
def test_secondary_optimization_direct_call():
    ...
    try:
        ...
        print(f"Framework data after primary optimization:")
        print(f"  - primary_theta: {framework.data.primary_theta is not None}")
        print(f"  - primary_position: {framework.data.primary_position is not None}")
