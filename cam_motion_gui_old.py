...
from CamPro_OptimalMotion import solve_cam_motion_law, CollocationSettings
...
class CamMotionGUI:
    ...
    def _solve_thread(self):
        ...
        try:
            ...
            print(f"DEBUG: Thread parameters:")
            print(f"  - Stroke: {stroke}")
            print(f"  - Upstroke duration: {upstroke_duration}%")
            print(f"  - Zero acceleration duration: {zero_accel_duration}%")
            print(f"  - Cycle time: {cycle_time}")
            ...
            print(f"DEBUG: Calling solve_cam_motion_law with:")
            print(f"  - stroke={stroke}")
    ...
    def _solve_ring_thread(self):
        ...
        try:
            ...
            print(f"DEBUG: Cam-ring system parameters:")
            ...
            print(f"  - System: Cam connected to linear follower via connecting rod")
            print(f"  - Ring profile: Computed from cam geometry and meshing law")
    ...
    def _update_plot(self, solution):
        ...
        try:
            ...
            print(f"DEBUG: Plot data shapes:")
    ...
    def _update_unified_plot(self, result_data):
        ...
        try:
            print(f"DEBUG: Updating unified plot with result data")
    ...
    def _update_all_plots(self, result_data):
        ...
        try:
            print(f"DEBUG: Updating all plots with result data")
