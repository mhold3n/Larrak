...
_agent_log(
    hypothesisId="Z",
    location="webapp/services/runner.py:module_import",
...
class Runner:
    ...
    async def run_module_async(self, module_id: str, params: Dict[str, Any]):
        ...
        _agent_log(
            hypothesisId="F",
            location="webapp/services/runner.py:run_module_async:entry",
        ...
        _agent_log(
            hypothesisId="B",
            location="webapp/services/runner.py:run_module_async",
    ...
    def run_module(self, module_id: str, params: Dict[str, Any]):
        ...
        _agent_log(
            hypothesisId="A",
            location="webapp/services/runner.py:run_module",
